...
public class ProjectApplicationController {
	...
	@GetMapping
	public ResponseEntity<ApiResponse<List<ApplicationSummary>>> getApplicationList(
			@AuthenticationPrincipal Long userSq) {
		return ResponseEntity.ok(ApiResponse.of(HttpStatus.OK, "프로젝트 지원 조회 성공",
				projectApplicationService.fetchProjectApplications(userSq)));
	}
