...
//    답변 수정
    @PutMapping("/{answerSq}")
    public ResponseEntity<ApiResponse<NullType>> updateAnswer(@RequestBody AnswerRequest answerRequest, @PathVariable("answerSq") Long answerSq){
...
//    답변 삭제
    ...
    public ResponseEntity<ApiResponse<NullType>> deleteAnswer(@PathVariable("answerSq") Long answerSq){
    	answerService.deleteAnswer(answerSq);
...
//  답변 추천 클릭
	...
	public ResponseEntity<ApiResponse<NullType>> updateRecommendAnswer(@PathVariable("answerSq") Long answerSq){
		answerService.updateAnswerRecommend(answerSq);
