<template lang="">
    <div class="d-flex layout-wrapper mx-auto">
        ...
        <main class = "content flex-grow-1 px-4">
            <div class="tab-pane tab-pane-navigation active show" id="projectRegisterForm" role="tabpanel">
    <h4 class="mb-3">프로젝트 등록</h4>
    <div class="card bg-color-grey mb-4">
        <div class="card-body">
            <form class="contact-form form-style-2" action="php/project-register.php" method="POST" novalidate="novalidate">
                <!-- 프로젝트 제목 -->
                <div class="row">
                    <div class="form-group col">
                        <label class="form-label mb-1 text-2" style="font-weight: bold;">프로젝트 제목</label>
                        <input type="text" class="form-control text-3 h-auto py-2" name="title" placeholder="예: 쇼핑몰 관리자 시스템 구축" v-model = "projectTitle" required="">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-lg-6">
                        <label class="form-label mb-1 text-2" style="font-weight: bold;">시</label>
                        <select class="form-select form-control h-auto" name="city" v-model = "selectedCity" required="">
                    ...
                    <div class="form-group col-lg-6">
                        <label class="form-label mb-1 text-2" style="font-weight: bold;">구</label>
                        <select class="form-select form-control h-auto" name="district" v-model = "selectedDistrict" required="">
                            <option value="">선택</option>
                ...
                <div class="row">
                    <div class="form-group col-lg-6">
                        <label class="form-label mb-1 text-2" style="font-weight: bold;">개발자 등급(경력)</label>
                        <select class="form-select form-control h-auto" name="career" v-model = "selectedDevGrade" required="">
                            <option value="">선택</option>
                    ...
                    <div class="form-group col-lg-6">
                        <label class="form-label mb-1 text-2" style="font-weight: bold;">학력</label>
                        <select class="form-select form-control h-auto" name="education" v-model = "selectedEducation" required="">
                            <option value="">선택</option>
                ...
                <div class="row">
                    <div class="form-group col">
                        <label class="form-label mb-1 text-2" style="font-weight: bold;">프로젝트 기간</label>
                        <input type="text" class="form-control text-3 h-auto py-2" name="period" placeholder="예: 2025-04 ~ 2025-10" v-model="projectPeriodDisplay" required="">
                    </div>
                </div>
                <!-- 모집 기간 -->
                <div class="row">
                    <div class="form-group col">
                        <label class="form-label mb-1 text-2" style="font-weight: bold;">모집 기간</label>
                        <input type="text" class="form-control text-3 h-auto py-2" name="period" placeholder="예: 2025-04 ~ 2025-10" v-model="recruitPeriodDisplay" required="">
                    </div>
                </div>
                <!-- 근무형태 / 모집직군 -->
                <div class="form-group mb-3">
                    <label class="form-label mb-1 text-2" style="font-weight: bold;">
                        근무 형태
                        <a href="#" @click.prevent="addContract" class="text-grey text-decoration-none small ms-2">+ 추가하기</a>
                    </label>
                ...
                <div class="form-group mb-3">
                    <label class="form-label mb-1 text-2" style="font-weight: bold;">
                        모집 직군
                        <a href="#" @click.prevent="addJob" class="text-grey text-decoration-none small ms-2">+ 추가하기</a>
                    </label>

                    <div id="selectedSkillsPreview" class="mb-2 d-flex gap-2 flex-wrap">
                        <ProjectRecruitButtonGroup v-if = "selectedJobs.length > 0"
                        @remove="removeJob"
                ...
                <div class="row">
                    <div class="form-group col">
                        <label class="form-label mb-1 text-2" style="font-weight: bold;">우대 사항</label>
                        <input type="text" class="form-control text-3 h-auto py-2" name="qualification" v-model="preferContent" required="">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col">
                        <label class="form-label mb-1 text-2" style="font-weight: bold;">상세 내용</label>
                        <textarea maxlength="5000" rows="6" class="form-control text-3 h-auto py-2" name="description" v-model="description" required=""></textarea>
                    </div>
                </div>

                
                <div class="form-group mb-3">
                    <label class="form-label mb-1 text-2" style="font-weight: bold; position: relative;">
                      인터뷰 가능 시간
                      <a href="#" class="text-grey text-decoration-none small ms-2">+ 추가하기</a>
                    </label>
...
const interviewTimes = ref([
  { date: '2025-04-01', timeSlots: ['10:00', '11:00'] },
  { date: '2025-04-02', timeSlots: ['13:00'] }
])
...
const removeContract = (id) => {
    selectedContractTypes.value = selectedContractTypes.value.filter(contract => contract.id !== id)
}
...
const removePreferSkill = (id) => {
    selectedPreferSkills.value = selectedPreferSkills.value.filter(preferSkill => preferSkill.id !== id)
}

const removeInterviewTime = (date) => {
    interviewTimes.value = interviewTimes.value.filter(interviewTimes => interviewTimes.date !== date)
}
...
watch(selectedCity, (newVal) => {
  console.log('도시 변경됨:', newVal)
})

watch(selectedDistrict, (newVal) => {
  console.log('구/동 변경됨:', newVal)
})


watch(projectStartDt, (newVal) => {
  console.log('프로젝트 시작 날짜 변경됨:', newVal)
})

watch(projectEndDt, (newVal) => {
  console.log('프로젝트 종료 날짜짜 변경됨:', newVal)
})

watch(selectedDevGrade, (newVal) => {
  console.log('개발자 등급 변경됨:', newVal)
})

watch(selectedEducation, (newVal) => {
  console.log('학력 변경됨:', newVal)
})

watch(preferContent, (newVal) => {
  console.log('우대사항 변경됨:', newVal)
})

watch(description, (newVal) => {
    console.log('상세내용 변경', newVal)
})
